...
const TopBooks = ({ books }) => {
  ...
  return (
    <>
      <div>
        <div>The most read books last month</div>
        <Swiper
          modules={[Pagination]}
          spaceBetween={45}
          slidesPerView="auto"
      ...
      <div>
        <div>The most read books last year</div>
        <Swiper
          modules={[Pagination]}
          spaceBetween={45}
          slidesPerView="auto"
      ...
      <div>
        <div>The highest rated books</div>
        <Swiper
          modules={[Pagination]}
          spaceBetween={45}
          slidesPerView="auto"
